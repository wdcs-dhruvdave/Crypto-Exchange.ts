        ...
        "WalletPage.useEffect": ()=>{
            const init = {
                "WalletPage.useEffect.init": async ()=>{
                    ...
                    if (data.length === 0) {
                        const newWallet = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$walletapi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createWallet"])(user.id);
...
_s(WalletPage, "SXwV23Zhv3grB/EH9xYQODn6w40=");
_c = WalletPage;
var _c;
