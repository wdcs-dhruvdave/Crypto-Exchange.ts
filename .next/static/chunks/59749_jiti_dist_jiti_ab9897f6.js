...
"[project]/node_modules/tailwindcss/node_modules/jiti/dist/jiti.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
(()=>{
    var __webpack_modules__ = {
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/classes/range.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            ...
            class Range {
                ...
                constructor(range, options){
                    ...
                    if (this.options = options, this.loose = !!options.loose, this.includePrerelease = !!options.includePrerelease, this.raw = range.trim().replace(SPACE_CHARACTERS, " "), this.set = this.raw.split("||").map((r)=>this.parseRange(r.trim())).filter((c)=>c.length), !this.set.length) throw new TypeError("Invalid SemVer Range: ".concat(this.raw));
            ...
            }, replaceStars = (comp, options)=>(debug("replaceStars", comp, options), comp.trim().replace(re[t.STAR], "")), replaceGTE0 = (comp, options)=>(debug("replaceGTE0", comp, options), comp.trim().replace(re[options.includePrerelease ? t.GTE0PRE : t.GTE0], "")), hyphenReplace = (incPr)=>($0, from, fM, fm, fp, fpr, fb, to, tM, tm, tp, tpr)=>"".concat(from = isX(fM) ? "" : isX(fm) ? ">=".concat(fM, ".0.0").concat(incPr ? "-0" : "") : isX(fp) ? ">=".concat(fM, ".").concat(fm, ".0").concat(incPr ? "-0" : "") : fpr ? ">=".concat(from) : ">=".concat(from).concat(incPr ? "-0" : ""), " ").concat(to = isX(tM) ? "" : isX(tm) ? "<".concat(+tM + 1, ".0.0-0") : isX(tp) ? "<".concat(tM, ".").concat(+tm + 1, ".0-0") : tpr ? "<=".concat(tM, ".").concat(tm, ".").concat(tp, "-").concat(tpr) : incPr ? "<".concat(tM, ".").concat(tm, ".").concat(+tp + 1, "-0") : "<=".concat(to)).trim(), testSet = (set, version, options)=>{
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/classes/semver.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            ...
            class SemVer {
                ...
                constructor(version, options){
                    ...
                    } else if ("string" != typeof version) throw new TypeError('Invalid version. Must be a string. Got type "'.concat(typeof version, '".'));
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/functions/coerce.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            ...
            module1.exports = (version, options)=>{
                ...
                const major = match[2], minor = match[3] || "0", patch = match[4] || "0", prerelease = options.includePrerelease && match[5] ? "-".concat(match[5]) : "", build = options.includePrerelease && match[6] ? "+".concat(match[6]) : "";
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/functions/parse.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            const SemVer = __webpack_require__("./node_modules/.pnpm/semver@7.6.3/node_modules/semver/classes/semver.js");
            module1.exports = function(version, options) {
                let throwErrors = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
                if (version instanceof SemVer) return version;
                try {
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/internal/re.js": (module1, exports, __webpack_require__)=>{
            ...
            const safeRegexReplacements = [
                ...
                const safe = ((value)=>{
                    for (const [token, max] of safeRegexReplacements)value = value.split("".concat(token, "*")).join("".concat(token, "{0,").concat(max, "}")).split("".concat(token, "+")).join("".concat(token, "{1,").concat(max, "}"));
                    return value;
                })(value), index = R++;
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/ranges/simplify.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            ...
            module1.exports = (versions, range, options)=>{
                ...
                const ranges = [];
                for (const [min, max] of set)min === max ? ranges.push(min) : max || min !== v[0] ? max ? min === v[0] ? ranges.push("<=".concat(max)) : ranges.push("".concat(min, " - ").concat(max)) : ranges.push(">=".concat(min)) : ranges.push("*");
        ...
        "./node_modules/.pnpm/semver@7.6.3/node_modules/semver/ranges/subset.js": (module1, __unused_webpack_exports, __webpack_require__)=>{
            ...
            module1.exports = function(sub, dom) {
    ...
    (()=>{
        ...
        const _UNC_REGEX = /^[/\\]{2}/, _IS_ABSOLUTE_RE = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/, _DRIVE_LETTER_RE = /^[A-Za-z]:$/, pathe_ff20891b_normalize = function(path) {
            ...
            let joined;
            for (const argument of arguments_)argument && argument.length > 0 && (void 0 === joined ? joined = argument : joined += "/".concat(argument));
        ...
        function normalizeAliases(_aliases) {
            ...
            const aliases = Object.fromEntries(Object.entries(_aliases).sort((param, param1)=>{
        ...
        function dist_hasTrailingSlash() {
        ...
        function formatList(array) {
            let type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "and";
            ...
            return messages.set(sym, value), function(Base, key) {
                ...
                function NodeError() {
                    ...
                    const message = function(key, parameters, self) {
                        ...
                        if (external_node_assert_namespaceObject(void 0 !== message, "expected `message` to be found"), "function" == typeof message) return external_node_assert_namespaceObject(message.length <= parameters.length, "Code: ".concat(key, "; The provided arguments length (").concat(parameters.length, ") does not match the required ones (").concat(message.length, ").")), Reflect.apply(message, self, parameters);
                        const regex = /%[dfijoOs]/g;
                        let expectedLength = 0;
                        for(; null !== regex.exec(message);)expectedLength++;
                        return external_node_assert_namespaceObject(expectedLength === parameters.length, "Code: ".concat(key, "; The provided arguments length (").concat(parameters.length, ") does not match the required ones (").concat(expectedLength, ").")), 0 === parameters.length ? message : (parameters.unshift(message), Reflect.apply(external_node_util_namespaceObject.format, null, parameters));
        ...
        codes.ERR_INVALID_ARG_TYPE = createError("ERR_INVALID_ARG_TYPE", (name, expected, actual)=>{
            ...
            let message = "The ";
            if (name.endsWith(" argument")) message += "".concat(name, " ");
            else {
            ...
            return types.length > 0 && (message += "".concat(types.length > 1 ? "one of type" : "of type", " ").concat(formatList(types, "or")), (instances.length > 0 || other.length > 0) && (message += " or ")), instances.length > 0 && (message += "an instance of ".concat(formatList(instances, "or")), other.length > 0 && (message += " or ")), other.length > 0 && (other.length > 1 ? message += "one of ".concat(formatList(other, "or")) : (other[0].toLowerCase() !== other[0] && (message += "an "), message += "".concat(other[0]))), message += ". Received ".concat(function(value) {
                ...
                if ("object" == typeof value) return value.constructor && value.constructor.name ? "an instance of ".concat(value.constructor.name) : "".concat((0, external_node_util_namespaceObject.inspect)(value, {
                    depth: -1
                }));
                ...
                return "type ".concat(typeof value, " (").concat(inspected, ")");
            }(actual)), message;
        }, TypeError), codes.ERR_INVALID_MODULE_SPECIFIER = createError("ERR_INVALID_MODULE_SPECIFIER", function(request, reason) {
            let base = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : void 0;
            return 'Invalid module "'.concat(request, '" ').concat(reason).concat(base ? " imported from ".concat(base) : "");
        }, TypeError), codes.ERR_INVALID_PACKAGE_CONFIG = createError("ERR_INVALID_PACKAGE_CONFIG", (path, base, message)=>"Invalid package config ".concat(path).concat(base ? " while importing ".concat(base) : "").concat(message ? ". ".concat(message) : ""), Error), codes.ERR_INVALID_PACKAGE_TARGET = createError("ERR_INVALID_PACKAGE_TARGET", function(packagePath, key, target) {
            let isImport = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, base = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : void 0;
            const relatedError = "string" == typeof target && !isImport && target.length > 0 && !target.startsWith("./");
            return "." === key ? (external_node_assert_namespaceObject(!1 === isImport), 'Invalid "exports" main target '.concat(JSON.stringify(target), " defined in the package config ").concat(packagePath, "package.json").concat(base ? " imported from ".concat(base) : "").concat(relatedError ? '; targets must start with "./"' : "")) : 'Invalid "'.concat(isImport ? "imports" : "exports", '" target ').concat(JSON.stringify(target), " defined for '").concat(key, "' in the package config ").concat(packagePath, "package.json").concat(base ? " imported from ".concat(base) : "").concat(relatedError ? '; targets must start with "./"' : "");
        }, Error), codes.ERR_MODULE_NOT_FOUND = createError("ERR_MODULE_NOT_FOUND", function(path, base) {
            let exactUrl = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
            return "Cannot find ".concat(exactUrl ? "module" : "package", " '").concat(path, "' imported from ").concat(base);
        }, Error), codes.ERR_NETWORK_IMPORT_DISALLOWED = createError("ERR_NETWORK_IMPORT_DISALLOWED", "import of '%s' by %s is not supported: %s", Error), codes.ERR_PACKAGE_IMPORT_NOT_DEFINED = createError("ERR_PACKAGE_IMPORT_NOT_DEFINED", (specifier, packagePath, base)=>'Package import specifier "'.concat(specifier, '" is not defined').concat(packagePath ? " in package ".concat(packagePath, "package.json") : "", " imported from ").concat(base), TypeError), codes.ERR_PACKAGE_PATH_NOT_EXPORTED = createError("ERR_PACKAGE_PATH_NOT_EXPORTED", function(packagePath, subpath) {
            let base = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : void 0;
            return "." === subpath ? 'No "exports" main defined in '.concat(packagePath, "package.json").concat(base ? " imported from ".concat(base) : "") : "Package subpath '".concat(subpath, '\' is not defined by "exports" in ').concat(packagePath, "package.json").concat(base ? " imported from ".concat(base) : "");
        }, Error), codes.ERR_UNSUPPORTED_DIR_IMPORT = createError("ERR_UNSUPPORTED_DIR_IMPORT", "Directory import '%s' is not supported resolving ES modules imported from %s", Error), codes.ERR_UNSUPPORTED_RESOLVE_REQUEST = createError("ERR_UNSUPPORTED_RESOLVE_REQUEST", 'Failed to resolve module specifier "%s" from "%s": Invalid relative URL or base scheme is not hierarchical.', TypeError), codes.ERR_UNKNOWN_FILE_EXTENSION = createError("ERR_UNKNOWN_FILE_EXTENSION", (extension, path)=>'Unknown file extension "'.concat(extension, '" for ').concat(path), TypeError), codes.ERR_INVALID_ARG_VALUE = createError("ERR_INVALID_ARG_VALUE", function(name, value) {
            let reason = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "is invalid";
            let inspected = (0, external_node_util_namespaceObject.inspect)(value);
        ...
        function read(jsonPath, param) {
            ...
            if (void 0 !== string) {
                ...
                try {
                    ...
                    const cause = error_, error = new ERR_INVALID_PACKAGE_CONFIG$1(jsonPath, (base ? '"'.concat(specifier, '" from ') : "") + (0, external_node_url_namespaceObject.fileURLToPath)(base || specifier), cause.message);
        ...
        function emitLegacyIndexDeprecation(url, packageJsonUrl, base, main) {
            ...
            main ? external_node_path_namespaceObject.resolve(packagePath, main) !== urlPath && external_node_process_namespaceObject.emitWarning("Package ".concat(packagePath, ' has a "main" field set to "').concat(main, '", excluding the full filename and extension to the resolved file at "').concat(urlPath.slice(packagePath.length), '", imported from ').concat(basePath, '.\n Automatic extension resolution of the "main" field is deprecated for ES modules.'), "DeprecationWarning", "DEP0151") : external_node_process_namespaceObject.emitWarning('No "main" or "exports" field defined in the package.json for '.concat(packagePath, ' resolving the main entry point "').concat(urlPath.slice(packagePath.length), '", imported from ').concat(basePath, '.\nDefault "index" lookups for the main are deprecated for ES modules.'), "DeprecationWarning", "DEP0151");
        }
        ...
        function invalidPackageTarget(subpath, target, packageJsonUrl, internal, base) {
            return target = "object" == typeof target && null !== target ? JSON.stringify(target, null, "") : "".concat(target), new ERR_INVALID_PACKAGE_TARGET((0, external_node_url_namespaceObject.fileURLToPath)(new external_node_url_namespaceObject.URL(".", packageJsonUrl)), subpath, target, internal, base && (0, external_node_url_namespaceObject.fileURLToPath)(base));
        }
        function resolvePackageTargetString(target, subpath, match, packageJsonUrl, base, pattern, internal, isPathMap, conditions) {
            ...
            if (null !== invalidSegmentRegEx.exec(subpath)) {
                ...
                if (null === deprecatedInvalidSegmentRegEx.exec(subpath)) {
                    ...
                    const reason = 'request is not a valid match in pattern "'.concat(match, '" for the "').concat(internal ? "imports" : "exports", '" resolution of ').concat((0, external_node_url_namespaceObject.fileURLToPath)(packageJsonUrl));
        ...
        function _tryModuleResolve(id, url, conditions) {
            try {
                ...
                if (!NOT_FOUND_ERRORS.has(error === null || error === void 0 ? void 0 : error.code)) throw error;
            }
        }
        function _resolve(id) {
            ...
            if (id.startsWith("file://") && (id = fileURLToPath(id)), isAbsolute(id)) try {
                ...
                if ("ENOENT" !== (error === null || error === void 0 ? void 0 : error.code)) throw error;
            }
            ...
            if (!resolved) {
                const error = new Error("Cannot find module ".concat(id, " imported from ").concat(urls.join(", ")));
        ...
        function createJITI(_filename) {
            let opts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, parentModule = arguments.length > 2 ? arguments[2] : void 0, parentCache = arguments.length > 3 ? arguments[3] : void 0;
            ...
            ], isNativeRe = new RegExp("node_modules/(".concat(nativeModules.map((m)=>escapeStringRegexp(m)).join("|"), ")/")), isTransformRe = new RegExp("node_modules/(".concat(transformModules.map((m)=>escapeStringRegexp(m)).join("|"), ")/"));
            function debug() {
                for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                    args[_key] = arguments[_key];
                }
            ...
            function transform(topts) {
                let code = function(filename, source, get) {
                    ...
                    const sourceHash = " /* v".concat(opts.cacheVersion, "-").concat(md5(source, 16), " */"), filebase = basename(pathe_ff20891b_dirname(filename)) + "-" + basename(filename), cacheFile = join(opts.cache, filebase + "." + md5(filename) + ".js");
            ...
            function evalModule(source) {
                let evalOptions = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                var _a;
                const id = evalOptions.id || (evalOptions.filename ? basename(evalOptions.filename) : "_jitiEval.".concat(evalOptions.ext || ".js")), filename = evalOptions.filename || _resolve(id), ext = evalOptions.ext || extname(filename), cache = evalOptions.cache || parentCache || {}, isTypescript = ".ts" === ext || ".mts" === ext || ".cts" === ext, isNativeModule = ".mjs" === ext || ".js" === ext && "module" === (null === (_a = function(path) {
                    for(; path && "." !== path && "/" !== path;){
                        path = join(path, "..");
                        try {
                ...
                if (mod.exports && mod.exports.__JITI_ERROR__) {
                    const { filename, line, column, code, message } = mod.exports.__JITI_ERROR__, err = new Error("".concat(code, ": ").concat(message, " \n ").concat("".concat(filename, ":").concat(line, ":").concat(column)));
