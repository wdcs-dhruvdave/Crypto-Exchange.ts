...
async function createWallet(userId, token = 'USD', balance = 0) {
    const newWallet = {
        userId,
        token,
        balance,
...
async function addMoney(walletId, currentBalance, amount) {
    ...
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`${BASE_URL}/${walletId}`, updatedWallet);
...
function WalletPage() {
    ...
    const handleAddMoney = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Failed to add money');
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__561948f3._.js.map