...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setError('');
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(data.email, data.password);
            if (user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2a79ed6._.js.map